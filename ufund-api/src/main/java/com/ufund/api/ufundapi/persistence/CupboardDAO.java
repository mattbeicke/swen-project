...
/**
 * Interface for Cupboard Data Access Object
 * 
 * @author Zach Coy
 */
public interface CupboardDAO {
    /**
     * Retrieves all {@link Need needs}
     * 
    ...
    /**
     * Searches for all {@link Need needs} whose name contains the given text
     * 
    ...
    /**
     * Retrieves a {@link Need need} with the given id
     * 
     * @param id The id of the {@link Need need} to get
     * 
     * @return a {@link Need need} object with the matching id
     *         or null if no {@link Need need} with a matching id is found
     * 
     * @throws IOException if an issue with underlying storage
     */
    ...
    /**
     * Creates and saves a {@link Need need}
     * 
     * @param need {@link Need need} object to be created and saved. The id of the
     *             need object is ignored and a new unique id is assigned
     *
    ...
    /**
     * Updates and saves a {@link Need need}
     * 
     * @param need a {@link Need need} object to be updated and saved
     * 
     ...
     * 
     * @return true if the {@link Need need} was deleted or
